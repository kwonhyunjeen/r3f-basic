...
export const SceneTemplate = ({ children, code, description, guide, title }: SceneTemplateProps) => {
  const [showCode, setShowCode] = React.useState(false);

  return (
    <div className="flex flex-col w-full max-w-3xl gap-6 m-auto">
      {/* Description */}
      ...
      {/* Rendering */}
      <div className="w-full bg-zinc-100 rounded-lg overflow-hidden ">
        <div className="w-full h-[400px] md:h-[500px]">{children}</div>
      </div>
